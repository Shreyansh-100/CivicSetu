...
class image_agent:
    ...
    def output(img:str,category:str):
        score=image_agent.check_ai(img)
        flag= image_agent.check_output(score)

        score=image_agent.check_score(img,category)
